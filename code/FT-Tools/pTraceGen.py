                                                                                                          ##############################################################################################################################
# SCRIPT TO GENERATE FAILURE "PREDICTION" TRACE BASED ON GIVEN FAILURE TRACE, PRECISION & RECALL
# FAILURE "PREDICTION" TRACE IS USED BY FT-SIM's FAILURE PREDICTION COMPONENT
##############################################################################################################################

##############################################################################################################################
#IMPORTANT NODE: The trace generated using this script should be sorted based on the timestamp field before using. 
##############################################################################################################################
